...
*
*  All code in the class assumes that the nodes and sf::Vector2is provided are within the bounds of the map limits
*/
...
public:
	...
	bool exists(const sf::Vector2i& pos);
	//assumes that the node exists in the collection
	AStarNode* get(int x, int y);
	bool isEmpty();
	void updateParent(const sf::Vector2i& pos, const sf::Vector2i& parent_pos, float score);
...
private:
	...
	/* This is an array of AStarNode sf::Vector2iers. This is the main data for this collection.
