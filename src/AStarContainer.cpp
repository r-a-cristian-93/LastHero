...
bool AStarContainer::exists(const sf::Vector2i& pos) {
...
void AStarContainer::updateParent(const sf::Vector2i& pos, const sf::Vector2i& parent_pos, float score) {
...
bool AStarCloseContainer::exists(const sf::Vector2i& pos) {
	return map_pos[pos.x][pos.y] != -1;
}
